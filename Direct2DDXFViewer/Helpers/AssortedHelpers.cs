...
namespace Direct2DDXFViewer.Helpers
{
    ...
    {
        public static float GetLineWidth(RenderTarget target, float lineWidthInPixels, float currentZoomLevel = 1)
        {
            ...
            float thicknessX = lineWidthInPixels / (dpiX / 96.0f);
            float thicknessY = lineWidthInPixels / (dpiY / 96.0f);
